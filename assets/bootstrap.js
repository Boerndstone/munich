...
const app = startStimulusApp(
  require.context(
    ...
    /\/(cookie-consent|collapsible|scroll[_-]progress|scrolltop|theme|autocomplete|search[_-]modal|sheet|tabs|rock[_-]grade[_-]chart|exclusive_details|dialog)_controller\.[jt]sx?$/
  )
);
