...
final class TopoPathSuggestionController extends AbstractController
{
    ...
    public function __construct(
        ...
        #[Autowire('%env(default::BACKOFFICE_BASE_URL)%')]
        private readonly ?string $backofficeBaseUrl,
    ...
    public function send(Request $request): JsonResponse
    {
        ...
        $adminListUrl = $this->buildBackofficeSuggestionListUrl();
    ...
    private function buildBackofficeSuggestionListUrl(): ?string
    {
        $baseUrl = trim((string) $this->backofficeBaseUrl);
        if ($baseUrl === '') {
            return null;
        }

        return rtrim($baseUrl, '/') . '/admin?crudAction=index&crudControllerFqcn=' . rawurlencode('App\\Controller\\Admin\\TopoPathSuggestionCrudController');
    }
