...
const app = startStimulusApp(
  require.context(
    ...
    /\/(cookie-consent|scroll[_-]progress|scrolltop|theme|grade[_-]preference|autocomplete|search[_-]modal|sheet|tabs|rock[_-]grade[_-]chart|exclusive_details|dialog|lazy[_-]navigation)_controller\.[jt]sx?$/
  )
);
